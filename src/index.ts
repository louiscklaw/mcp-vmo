...
function addListWinterVegetablesPrice(server: FastMCP<undefined>) {
  server.addTool({
...
function addListSummerVegetablesPrice(server: FastMCP<undefined>) {
  server.addTool({
...
function addListLeafyVegetablesPrice(server: FastMCP<undefined>) {
  server.addTool({
...
function addListMelonsPrice(server: FastMCP<undefined>) {
  server.addTool({
...
function addListFruitsPrice(server: FastMCP<undefined>) {
  server.addTool({
...
function addListRootsPrice(server: FastMCP<undefined>) {
  server.addTool({
...
function addListBeansPrice(server: FastMCP<undefined>) {
  server.addTool({
...
function addListHerbsPrice(server: FastMCP<undefined>) {
  server.addTool({
...
function addListMushroomsPrice(server: FastMCP<undefined>) {
  server.addTool({
...
function addListOthersPrice(server: FastMCP<undefined>) {
  server.addTool({
...
//
function addListAllVegetablesPrice(server: FastMCP<undefined>) {
  server.addTool({
